    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn
                    v-if="!editMode && operableStartOrder"
                    color="deep-purple lighten-2"
                    text
                    @click="startOrder"
            >
            ...
            <v-btn
                    v-if="!editMode && operableCancelOrder"
                    color="deep-purple lighten-2"
                    text
                    @click="cancelOrder"
            >
...
<script>
    ...
    export default {
        ...
        data: () => ({
            ...
            userRoles: [],
            operableStartOrder: false
            operableCancelOrder: false

        }),
        created(){
            var me = this
            me.userRoles = localStorage.getItem('user_roles')

            if(me.userRoles.includes('customer')){
                me.operableStartOrder = true
            }
            if(me.userRoles.includes('master')){
                me.operableCancelOrder = true
            }
